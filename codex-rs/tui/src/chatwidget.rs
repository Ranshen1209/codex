...
const TRUSTED_ACCESS_FOR_CYBER_VERIFICATION_WARNING: &str = "Your conversations have multiple flags for possible cybersecurity risk. Responses may take longer because extra safety checks are on. Try rephrasing your request if this seems incorrect.";
// SAKRYLLE: brand replacement
const MEMORIES_DOC_URL: &str = "https://doc.sakrylle.com/developers/memories";
